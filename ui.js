          ...
          events.forEach(element => {
                ...
                if(eventAction === "registration"){
                    ...
                    if(regAge[0] > 1){
                      ...
                      // for firefox
                      function tabIconChange(tabs) {
                        // tabs[0].url requires the `tabs` permission
                        // console.log(tabs[0].id);
                        var tabId = tabs[0].id;
                        browser.browserAction.setIcon({tabId: tabId,path:"img/green-isif.png"});
                      ...
                      querying.then(tabIconChange, onError);
                      // close firefox
                      ...
                      regAgeOutput +='</dd>';    
                       ...
                       function tabIconChange(tabs) {
                        ...
                        // console.log(tabs[0].id);
                        var tabId = tabs[0].id;
                        browser.browserAction.setIcon({tabId: tabId,path:"img/rdap-logo-red.png"});
                        //chrome.browserAction.setIcon({tabId: tab.id,path:"img/green-isif.png"});
                      }
                      function onError(error) {
                        console.log(`Error: ${error}`);
